class Config91 {
  static final videoCategories = {
    '最近加精(首页)': 'http://91porn.com/v.php?category=rf&viewtype=basic&page=',
    '当前最热': 'http://91porn.com/v.php?category=hot&viewtype=basic&page=',
    '最近得分': 'http://91porn.com/v.php?category=rp&viewtype=basic&page=',
    '10分钟以上': 'http://91porn.com/v.php?category=long&viewtype=basic&page=',
    ...
    '高清': 'http://91porn.com/v.php?category=hd&viewtype=basic&page='
  };
}
